namespace Client
{
    partial class ClientUI
    {
        ...
        private void InitializeComponent()
        {
            ...
            button2.FlatAppearance.MouseDownBackColor = Color.FromArgb(25, 25, 25);
            button2.FlatAppearance.MouseOverBackColor = Color.FromArgb(25, 25, 25);
            ...
            button3.FlatAppearance.MouseDownBackColor = Color.FromArgb(25, 25, 25);
            button3.FlatAppearance.MouseOverBackColor = Color.FromArgb(25, 25, 25);
            ...
            button4.FlatAppearance.MouseDownBackColor = Color.FromArgb(25, 25, 25);
            ...
            button5.FlatAppearance.MouseDownBackColor = Color.FromArgb(25, 25, 25);
            button5.FlatAppearance.MouseOverBackColor = Color.FromArgb(25, 25, 25);
            button5.FlatStyle = FlatStyle.Flat;
            button5.Font = new Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point, 204);
            button5.ForeColor = Color.White;
            button5.Image = (Image)resources.GetObject("button5.Image");
            button5.ImageAlign = ContentAlignment.MiddleLeft;
            button5.Location = new Point(17, 924);
            button5.Name = "button5";
            button5.Size = new Size(367, 78);
            button5.TabIndex = 8;
            button5.Text = "Logout";
